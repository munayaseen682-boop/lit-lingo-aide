...
import { LogOut, BookOpen, Sparkles, GraduationCap, MessagesSquare, LayoutDashboard, Download, Trophy, Clapperboard } from "lucide-react";
...
const navItems = [
  ...
  { to: "/slides" as const, label: "Slides", icon: Clapperboard, disabled: false },
];
